...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textContent2 = (TextView) convertView.findViewById(R.id.text_content2);
            holder.textContent3 = (TextView) convertView.findViewById(R.id.text_content3);
            holder.textContent4 = (TextView) convertView.findViewById(R.id.text_content4);
        ...
        holder.textContent2.setText(dto.getContent2());
        holder.textContent3.setText(dto.getContent3());
        holder.textContent4.setText(dto.getContent4());
