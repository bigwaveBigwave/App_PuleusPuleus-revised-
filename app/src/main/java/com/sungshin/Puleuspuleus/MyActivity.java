...
public class MyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView view_Email = (TextView) findViewById(R.id.VEmail);
        Button button_my_ok = (Button)findViewById(R.id.button_my_ok);
        ...
        button_my_ok.setOnClickListener(new View.OnClickListener() {
            @Override
